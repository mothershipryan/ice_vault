        ...
        <div className="w-full max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="space-y-8 text-slate-700 dark:text-slate-300 leading-relaxed font-light transition-colors">
                <section className="space-y-3">
                    <h3 className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm transition-colors">01. Zero-Knowledge Architecture</h3>
                    <p>
                ...
                <section className="space-y-3">
                    <h3 className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm transition-colors">02. Client-Side Encryption</h3>
                    <p>
                ...
                <section className="space-y-3">
                    <h3 className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm transition-colors">03. No User Tracking</h3>
                    <p>
                ...
                <div className="p-4 bg-red-600/10 dark:bg-red-500/10 border border-red-600/20 dark:border-red-500/20 rounded-xl mt-8 transition-colors">
                    <h4 className="text-red-700 dark:text-red-400 font-bold uppercase text-xs tracking-widest mb-2 transition-colors">Legal Disclaimer</h4>
