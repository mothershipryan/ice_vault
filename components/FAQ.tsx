...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Switch to 'Retrieval' mode in the main terminal. You can locate your encrypted assets by searching for the State, City, and Date of the occurrence. Each retrieval provides a secure link to the German node and a cryptographic hash for authenticity verification."
  },
  {
    q: "How is my privacy guaranteed?",
    a: "We provide zero-knowledge privacy. This means your data is encrypted locally before it ever reaches our servers. Because our infrastructure is hosted in Europe (Germany), your data is also protected by stringent EU privacy laws."
  },
  {
    q: "Is my footage secure?",
    a: "Yes. All assets are encrypted using zero-knowledge protocols. We utilize Supabase for secure data orchestration and Filen for encrypted object storage, ensuring that only you hold the keys to your footage."
  },
  {
    q: "Where is the data physically stored?",
    a: "To protect against extrajudicial data requests, all ICE Vault infrastructure is hosted in Germany. This ensures your data is protected by strict German privacy laws and European GDPR standards."
  },
  {
    q: "What happens if my phone is seized?",
    a: "Because ICE Vault uploads directly to our secure German nodes, the footage is preserved even if the physical device is destroyed or confiscated immediately after the upload completes."
  },
  {
